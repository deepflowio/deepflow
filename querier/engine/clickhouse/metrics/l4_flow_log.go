...
var L4_FLOW_LOG_METRICS_REPLACE = map[string]*Metrics{
	...
	"bbp":       NewReplaceMetrics("(byte_tx+byte_rx)/(packet_tx+packet_rx)", ""),
	...
	"retrans_ratio":     NewReplaceMetrics("(retrans_tx+retrans_rx)/(packet_tx+packet_rx)", ""),
	"retrans_tx_ratio":  NewReplaceMetrics("retrans_tx/packet_tx", ""),
	"retrans_rx_ratio":  NewReplaceMetrics("retrans_rx/packet_rx", ""),
	"zero_win_ratio":    NewReplaceMetrics("(zero_win_tx+zero_win_rx)/(packet_tx+packet_rx)", ""),
	...
	"tcp_establish_fail_ratio":    NewReplaceMetrics(DB_FIELD_TCP_ESTABLISH_FAIL+"/"+DB_FIELD_CLOSED_FLOW, ""),
	"client_establish_fail_ratio": NewReplaceMetrics(DB_FIELD_CLIENT_ESTABLISH_FAIL+"/"+DB_FIELD_CLOSED_FLOW, ""),
	"server_establish_fail_ratio": NewReplaceMetrics(DB_FIELD_SERVER_ESTABLISH_FAIL+"/"+DB_FIELD_CLOSED_FLOW, ""),

	"tcp_transfer_fail":          NewReplaceMetrics(DB_FIELD_TCP_TRANSFER_FAIL, ""),
	"tcp_transfer_fail_ratio":    NewReplaceMetrics(DB_FIELD_TCP_TRANSFER_FAIL+"/"+DB_FIELD_CLOSED_FLOW, ""),
	"tcp_rst_fail":               NewReplaceMetrics(DB_FIELD_TCP_RST_FAIL, ""),
	"tcp_rst_fail_ratio":         NewReplaceMetrics(DB_FIELD_TCP_RST_FAIL+"/"+DB_FIELD_CLOSED_FLOW, ""),
	...
	"rtt_avg":    NewReplaceMetrics("rtt/1", ""),
	...
	"vpc_0":         NewReplaceMetrics("[toString(l3_epc_id_0)]", "NOT (l3_epc_id_0 = -2)"),
	"subnet_0":      NewReplaceMetrics("[toString(subnet_id_0)]", "NOT (subnet_id_0 = 0)"),
	...
	"pod_cluster_0": NewReplaceMetrics("[toString(pod_cluster_id_0)]", "NOT (pod_cluster_id_0 = 0)"),
	"pod_node_0":    NewReplaceMetrics("[toString(pod_node_id_0)]", "NOT (pod_node_id_0 = 0)"),
	"pod_ns_0":      NewReplaceMetrics("[toString(pod_ns_id_0)]", "NOT (pod_ns_id_0 = 0)"),
	"pod_group_0":   NewReplaceMetrics("[toString(pod_group_id_0)]", "NOT (pod_group_id_0 = 0)"),
	"pod_0":         NewReplaceMetrics("[toString(pod_id_0)]", "NOT (pod_id_0 = 0)"),
	"host_0":        NewReplaceMetrics("[toString(host_id_0)]", "NOT (host_id_0 = 0)"),
	"vm_0":          NewReplaceMetrics("[toString(l3_device_id_0), toString(l3_device_type_0)]", "(NOT (l3_device_id_0 = 0)) AND (l3_device_type_0 = 1)"),
	"region_0":      NewReplaceMetrics("[toString(region_id_0)]", "NOT (region_id_0 = 0)"),
	"az_0":          NewReplaceMetrics("[toString(az_id_0)]", "NOT (az_id_0 = 0)"),
	"vpc_1":         NewReplaceMetrics("[toString(l3_epc_id_1)]", "NOT (l3_epc_id_1 = -2)"),
	"subnet_1":      NewReplaceMetrics("[toString(subnet_id_1)]", "NOT (subnet_id_1 = 0)"),
	...
	"pod_cluster_1": NewReplaceMetrics("[toString(pod_cluster_id_1)]", "NOT (pod_cluster_id_1 = 0)"),
	"pod_node_1":    NewReplaceMetrics("[toString(pod_node_id_1)]", "NOT (pod_node_id_1 = 0)"),
	"pod_ns_1":      NewReplaceMetrics("[toString(pod_ns_id_1)]", "NOT (pod_ns_id_1 = 0)"),
	"pod_group_1":   NewReplaceMetrics("[toString(pod_group_id_1)]", "NOT (pod_group_id_1 = 0)"),
	"pod_1":         NewReplaceMetrics("[toString(pod_id_1)]", "NOT (pod_id_1 = 0)"),
	"host_1":        NewReplaceMetrics("[toString(host_id_1)]", "NOT (host_id_1 = 0)"),
	"vm_1":          NewReplaceMetrics("[toString(l3_device_id_1), toString(l3_device_type_1)]", "(NOT (l3_device_id_1 = 0)) AND (l3_device_type_1 = 1)"),
	"region_1":      NewReplaceMetrics("[toString(region_id_1)]", "NOT (region_id_1 = 0)"),
	"az_1":          NewReplaceMetrics("[toString(az_id_1)]", "NOT (az_id_1 = 0)"),
}

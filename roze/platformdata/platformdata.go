...
func New(ips []net.IP, port int, processName string, pcapDataPath string, receiver *receiver.Receiver) {
	PlatformData = grpc.NewPlatformInfoTable(ips, port, processName, pcapDataPath, receiver)

...
func newMatchedField(tap TapType, proto uint8, srcMac, dstMac uint64, srcIp, dstIp uint32, srcPort, dstPort uint16) MatchedField {
...
func TestSetGet1(t *testing.T) {
	matched := newMatchedField(66, 3, 10, 30, 20, 40, 50, 60)
...
func TestSetGet2(t *testing.T) {
	matched := newMatchedField(0xff, 0x7, 10, 30, 20, 40, 50, 60)
...
func TestBitZero(t *testing.T) {
	matched := newMatchedField(1, 1, 1, 1, 0, 1, 1, 0)
...
func TestTableIndex(t *testing.T) {
	matched := newMatchedField(1, 1, 1, 1, 1, 1, 0, 0)
	maskVector := newMatchedField(1, 1, 0, 0, 0, 0, 0, 0)
	...
	matched = newMatchedField(1, 1, 1, 1, 1, 1, 1, 1)
	maskVector = newMatchedField(0, 0, 0, 0, 0, 1, 1, 1)
...
func TestMatchedFieldGetAllTableIndex(t *testing.T) {
	...
	matched := newMatchedField(1, 3, 10, 30, 20, 40, 5, 60)
	vector := newMatchedField(0, 0, 0, 0, 0, 0, 7, 0)
	mask := newMatchedField(0, 0, 0, 0, 0, 0, 9, 0)

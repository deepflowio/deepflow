...
#### Bug Fix
* fix: Update inner_interface_capture_enabled to agent_restart [#9157](https://github.com/deepflowio/deepflow/pull/9157) by [rvql](https://github.com/rvql)
* fix: Some settings not updated [#9150](https://github.com/deepflowio/deepflow/pull/9150) by [rvql](https://github.com/rvql)
* fix: invalid include region [#9135](https://github.com/deepflowio/deepflow/pull/9135) by [askyrie](https://github.com/askyrie)
...
#### NEW FEATURE
* feat: add dpdk ebpf windows [#9156](https://github.com/deepflowio/deepflow/pull/9156) by [yuanchaoa](https://github.com/yuanchaoa)
* feat: agent list add pod cluster [#9153](https://github.com/deepflowio/deepflow/pull/9153) by [askyrie](https://github.com/askyrie)
* feat: remove non-empty filtering of host grouping [#9149](https://github.com/deepflowio/deepflow/pull/9149) by [xiaochaoren1](https://github.com/xiaochaoren1)
* feat: server add ping [#9138](https://github.com/deepflowio/deepflow/pull/9138) by [yuanchaoa](https://github.com/yuanchaoa)
...
#### OTHER
* V66 agent group downgrade [#9160](https://github.com/deepflowio/deepflow/pull/9160) by [ZhengYa-0110](https://github.com/ZhengYa-0110)

...
#### Bug Fix
* fix: specific prome remote read content-type [#9141](https://github.com/deepflowio/deepflow/pull/9141) by [taloric](https://github.com/taloric)
...
#### NEW FEATURE
* feat: Support packet capture in multiple namespaces [#9143](https://github.com/deepflowio/deepflow/pull/9143) by [rvql](https://github.com/rvql)

...
#### Bug Fix
* fix: vtap-interfaces responses wrong host info [#9104](https://github.com/deepflowio/deepflow/pull/9104) by [ZhengYa-0110](https://github.com/ZhengYa-0110)
...
#### NEW FEATURE
* Revert "feat: update agent-upgrade cli" [#9108](https://github.com/deepflowio/deepflow/pull/9108) by [askyrie](https://github.com/askyrie)

...
#### Bug Fix
* fix: trisolaris update expected_revision [#9058](https://github.com/deepflowio/deepflow/pull/9058) by [askyrie](https://github.com/askyrie)
...
#### NEW FEATURE
* feat: [controller & cli] support cancel agent upgrade [#9060](https://github.com/deepflowio/deepflow/pull/9060) by [SongZhen0704](https://github.com/SongZhen0704)

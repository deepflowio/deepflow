...
#### Bug Fix
* fix: incorrect l7 metrics [#9770](https://github.com/deepflowio/deepflow/pull/9770) by [yuanchaoa](https://github.com/yuanchaoa)
...
#### NEW FEATURE
* feat: Support k8s pod nic with same mac and tap_index [#9771](https://github.com/deepflowio/deepflow/pull/9771) by [rvql](https://github.com/rvql)
* feat: agent - eBPF Add l7 protocol to the close event [#9764](https://github.com/deepflowio/deepflow/pull/9764) by [yinjiping](https://github.com/yinjiping)

...
#### Bug Fix
* fix: ignore process config [#9532](https://github.com/deepflowio/deepflow/pull/9532) by [taloric](https://github.com/taloric)
...
#### NEW FEATURE
* feat: Add `Parse Failed` L7ResponseStatus [#9535](https://github.com/deepflowio/deepflow/pull/9535) by [rvql](https://github.com/rvql)

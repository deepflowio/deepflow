...
#### Bug Fix
* fix: incorrect acl_gids [#11858](https://github.com/deepflowio/deepflow/pull/11858) by [yuanchaoa](https://github.com/yuanchaoa)
* fix: enable setns in Java version preflight [#11857](https://github.com/deepflowio/deepflow/pull/11857) by [yinjiping](https://github.com/yinjiping)
...
#### NEW FEATURE
* feat: npb support for circuit breaking [#11863](https://github.com/deepflowio/deepflow/pull/11863) by [yuanchaoa](https://github.com/yuanchaoa)
* feat: add exception details [#11862](https://github.com/deepflowio/deepflow/pull/11862) by [yuanchaoa](https://github.com/yuanchaoa)
* feat: vtap add exception description [#11861](https://github.com/deepflowio/deepflow/pull/11861) by [askyrie](https://github.com/askyrie)

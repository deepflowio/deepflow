...
var (
	...
	CH_DICTIONARY_BIZ_SERVICE    = "biz_service_map"
	RESOURCE_TYPE_CH_BIZ_SERVICE = chDictNameToMetaDBTableName(CH_DICTIONARY_BIZ_SERVICE)
...
var CREATE_SQL_MAP = map[string]string{
	...
	CH_DICTIONARY_BIZ_SERVICE: CREATE_BIZ_SERVICE_DICTIONARY_SQL,

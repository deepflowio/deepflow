...
// topic: 主题
// subscriber: 订阅者
func Subscribe(pubSubType, topic int, subscriber interface{}) error {
...
func (m *Manager) Subscribe(pubSubType, topic int, subscriber interface{}) error {
...
func (m *Manager) GetPubSub(pubSubType int) PubSub {
	ps, ok := m.TypeToPubSub[pubSubType]
	if !ok {
		return nil
	}

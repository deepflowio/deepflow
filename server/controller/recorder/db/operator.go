...
func (o *OperatorBase[MT]) AddBatch(dbItems []*MT) ([]*MT, bool) {
	dbItems, lcuuids, ok := o.checkIfAddLcuuidsDup(dbItems)
	if !ok {
		return nil, false
	}
...
// 若资源无软删除需求，抛出lcuuid重复异常。
func (o *OperatorBase[MT]) checkIfAddLcuuidsDup(dbItems []*MT) (reorganizedDBItems []*MT, lcuuids []string, ok bool) {

...
func TestAddPodService(t *testing.T) {
	...
	dbItem.ProduceByAdd([]*metadbmodel.PodService{{Base: metadbmodel.Base{ID: id}, Name: name}})
	...
	dbItem.ProduceByAdd([]*metadbmodel.PodService{{Name: RandName()}, {Name: RandName()}})

...
func (p *PodGroup) getUpdateableFields() []string {
	return []string{"name", "type", "pod_num", "label", "region"}
}
...
func (p *PodGroup) setUpdatedFields(dbItem *mysqlmodel.PodGroup, updateInfo *message.PodGroupFieldsUpdate) {

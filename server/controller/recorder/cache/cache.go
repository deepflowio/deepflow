...
func (c *Cache) refreshVMs() {
	...
	vms, err := rcommon.PageWhereFind[mysqlmodel.VM](c.metadata, c.getConditionDomainCreateMethod())
	if err != nil {
		c.refreshFailed = true
...
func (c *Cache) refreshVPCs() {
	...
	vpcs, err := rcommon.PageWhereFind[mysqlmodel.VPC](c.metadata, c.getConditionDomainCreateMethod())
	if err != nil {
		c.refreshFailed = true
...
func (c *Cache) refreshNetworks() []int {
	...
	networkIDs := []int{}
	networks, err := rcommon.PageWhereFind[mysqlmodel.Network](c.metadata, c.getConditionDomainSubDomainCreateMethod())
	if err != nil {
		c.refreshFailed = true
...
func (c *Cache) refreshVInterfaces() {
	...
	vifs, err := rcommon.PageWhereFind[mysqlmodel.VInterface](c.metadata, c.getConditionDomainSubDomainCreateMethod())
	if err != nil {
		c.refreshFailed = true
...
func (c *Cache) refreshWANIPs() {
	...
	wanIPs, err := rcommon.PageWhereFind[mysqlmodel.WANIP](c.metadata, c.getConditionDomainSubDomainCreateMethod())
	if err != nil {
		c.refreshFailed = true
...
func (c *Cache) refreshLANIPs() {
	...
	lanIPs, err := rcommon.PageWhereFind[mysqlmodel.LANIP](c.metadata, c.getConditionDomainSubDomainCreateMethod())
	if err != nil {
		c.refreshFailed = true
...
func (c *Cache) refreshPodNodes() {
	...
	podNodes, err := rcommon.PageWhereFind[mysqlmodel.PodNode](c.metadata, c.getConditionDomainSubDomain())
	if err != nil {
		c.refreshFailed = true
...
func (c *Cache) refreshPodNamespaces() {
	...
	podNamespaces, err := rcommon.PageWhereFind[mysqlmodel.PodNamespace](c.metadata, c.getConditionDomainSubDomain())
	if err != nil {
		c.refreshFailed = true
...
func (c *Cache) refreshPodIngresses() []int {
	...
	podIngressIDs := []int{}
	podIngresses, err := rcommon.PageWhereFind[mysqlmodel.PodIngress](c.metadata, c.getConditionDomainSubDomain())
	if err != nil {
		c.refreshFailed = true
...
func (c *Cache) refreshPodIngressRules(podIngressIDs []int) {
	...
	podIngressRules, err := rcommon.PageWhereFind[mysqlmodel.PodIngressRule](c.metadata, c.getConditionDomainSubDomain())
	if err != nil {
		c.refreshFailed = true
...
func (c *Cache) refreshPodIngresseRuleBackends(podIngressIDs []int) {
	...
	podIngressRuleBackends, err := rcommon.PageWhereFind[mysqlmodel.PodIngressRuleBackend](c.metadata, c.getConditionDomainSubDomain())
	if err != nil {
		c.refreshFailed = true
...
func (c *Cache) refreshPodServices() []int {
	...
	podServiceIDs := []int{}
	podServices, err := rcommon.PageWhereFind[mysqlmodel.PodService](c.metadata, c.getConditionDomainSubDomain())
	if err != nil {
		c.refreshFailed = true
...
func (c *Cache) refreshPodServicePorts(podServiceIDs []int) {
	...
	podServicePorts, err := rcommon.PageWhereFind[mysqlmodel.PodServicePort](c.metadata, c.getConditionDomainSubDomain())
	if err != nil {
		c.refreshFailed = true
...
func (c *Cache) refreshPodGroups() {
	...
	podGroups, err := rcommon.PageWhereFind[mysqlmodel.PodGroup](c.metadata, c.getConditionDomainSubDomain())
	if err != nil {
		c.refreshFailed = true
...
func (c *Cache) refreshPodGroupPorts(podServiceIDs []int) {
	...
	podGroupPorts, err := rcommon.PageWhereFind[mysqlmodel.PodGroupPort](c.metadata, c.getConditionDomainSubDomain())
	if err != nil {
		c.refreshFailed = true
...
func (c *Cache) refreshPodReplicaSets() {
	...
	podReplicaSets, err := rcommon.PageWhereFind[mysqlmodel.PodReplicaSet](c.metadata, c.getConditionDomainSubDomain())
	if err != nil {
		c.refreshFailed = true
...
func (c *Cache) refreshPods() {
	...
	pods, err := rcommon.PageWhereFind[mysqlmodel.Pod](c.metadata, c.getConditionDomainSubDomain())
	if err != nil {
		c.refreshFailed = true
...
func (c *Cache) refreshConfigMaps() {
	...
	configMaps, err := rcommon.PageSelectWhereFind[mysqlmodel.ConfigMap](c.metadata, []string{"lcuuid", "name", "data_hash", "id", "domain"}, c.getConditionDomainSubDomain())
	if err != nil {
		c.refreshFailed = true
...
func (c *Cache) refreshPodGroupConfigMapConnections() {
	...
	items, err := rcommon.PageWhereFind[mysqlmodel.PodGroupConfigMapConnection](c.metadata, c.getConditionDomainSubDomain())
	if err != nil {
		c.refreshFailed = true
...
func (c *Cache) refreshProcesses() {
	...
	processes, err := rcommon.PageWhereFind[mysqlmodel.Process](c.metadata, c.getConditionDomainSubDomain())
	if err != nil {
		c.refreshFailed = true

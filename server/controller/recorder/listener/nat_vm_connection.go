...
func (c *NATVMConnection) OnUpdaterAdded(addedDBItems []*metadbmodel.NATVMConnection) {
...
func (c *NATVMConnection) OnUpdaterDeleted(lcuuids []string, deletedDBItems []*metadbmodel.NATVMConnection) {

...
func (i *PodIngress) OnUpdaterAdded(addedDBItems []*metadbmodel.PodIngress) {
...
func (i *PodIngress) OnUpdaterDeleted(lcuuids []string, deletedDBItems []*metadbmodel.PodIngress) {

...
INSERT INTO alarm_policy(user_id, tag_conditions, query_conditions, query_url, query_params, name, level, state,
    ...
    'statistics/v1/stats/querier/Top', '{\"fill\":\"none\",\"SLIMIT\":10000,\"interval\":60,\"window_size\":1,\"DATABASE\":\"deepflow_tenant\",\"TABLE\":\"deepflow_server_controller_resource_relation_exception\",\"QUERIES\":[{\"QUERY_ID\":\"R1\",\"ROLES\":[\"R\"],\"WHERE\":\"`tag.type`=\'device_ip_connection\'\",\"SELECT\":\"newTag(\'R1\') as query_id, Sum(`metrics.count`) AS `Sum(metrics.count)`, node_type(\'_\') AS `node_type`, -42 AS `icon_id`, newTag(\'_\') AS `_`, `tag.domain`\",\"TAGS\":[\"node_type(\'_\') AS `node_type`\",\"-42 AS `icon_id`\",\"newTag(\'_\') AS `_`\",\"`tag.domain`\"],\"METRICS\":[\"Sum(`metrics.count`) AS `Sum(metrics.count)`\"],\"GROUP_BY\":\"_, `tag.domain`, `node_type`\"}]}',
...
INSERT INTO alarm_policy(user_id, tag_conditions, query_conditions, query_url, query_params, name, level, state,
    ...
    'statistics/v1/stats/querier/Top', '{\"fill\":\"none\",\"SLIMIT\":10000,\"interval\":60,\"window_size\":1,\"DATABASE\":\"deepflow_tenant\",\"TABLE\":\"deepflow_server_controller_resource_relation_exception\",\"QUERIES\":[{\"QUERY_ID\":\"R1\",\"ROLES\":[\"R\"],\"WHERE\":\"`tag.type`=\'chost_pod_node_connection\'\",\"SELECT\":\"newTag(\'R1\') as query_id, Sum(`metrics.count`) AS `Sum(metrics.count)`, node_type(\'_\') AS `node_type`, -42 AS `icon_id`, newTag(\'_\') AS `_`, `tag.domain`\",\"TAGS\":[\"node_type(\'_\') AS `node_type`\",\"-42 AS `icon_id`\",\"newTag(\'_\') AS `_`\",\"`tag.domain`\"],\"METRICS\":[\"Sum(`metrics.count`) AS `Sum(metrics.count)`\"],\"GROUP_BY\":\"_, `tag.domain`, `node_type`\"}]}',

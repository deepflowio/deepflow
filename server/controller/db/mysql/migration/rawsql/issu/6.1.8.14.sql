...
set @lcuuid = (select uuid());
INSERT INTO data_source (name, tsdb_type, `interval`, retention_time, lcuuid) VALUES ('deepflow_system', 'deepflow_system', 0, 7*24, @lcuuid);

UPDATE db_version SET version = '6.1.8.14';

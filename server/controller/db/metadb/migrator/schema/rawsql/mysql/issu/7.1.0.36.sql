...
BEGIN
    ...
    END IF;
END;
CALL AddColumnIfNotExists('alarm_event', 'updated_at', 'TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP', 'lcuuid');
...
-- Update DB version
UPDATE db_version SET version='7.1.0.36';

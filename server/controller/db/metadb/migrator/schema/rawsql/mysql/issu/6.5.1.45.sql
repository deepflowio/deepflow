...
CALL AddColumnAndSetIfNotExists('consumer_bill', 'team_id', 'INTEGER', '1', 'id');
CALL AddColumnAndSetIfNotExists('consumer_bill', 'org_id', 'INTEGER', '1', 'id');
...
UPDATE db_version SET version='6.5.1.45';
-- modify end

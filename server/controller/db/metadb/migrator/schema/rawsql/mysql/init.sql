...
CREATE TABLE IF NOT EXISTS pod_config_map (
    id                  INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY,
    name                VARCHAR(256) NOT NULL,
    content             TEXT COMMENT 'yaml',
...
CREATE TABLE IF NOT EXISTS pod_group_config_map_connection (
    ...
    updated_at          DATETIME NOT NULL ON UPDATE CURRENT_TIMESTAMP DEFAULT CURRENT_TIMESTAMP
    INDEX pod_group_id_index(pod_group_id),
    INDEX pod_config_map_id_index(pod_config_map_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1;

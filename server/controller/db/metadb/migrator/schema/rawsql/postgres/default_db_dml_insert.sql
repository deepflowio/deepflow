...
INSERT INTO alarm_policy (
    ...
    threshold_error, lcuuid)
VALUES (
    1, 1, '过滤项: N/A | 分组项: *', '', '/v1/alarm/voucher-7days/', '{}', '[{"OPERATOR": {"return_field": "sysalarm_value", "return_field_description": "余额预估可用天数", "return_field_unit": "天"}}]', 'DeepFlow 服务即将停止', 1, 1, 1, 24, 1, '', '', '{"displayName":"sysalarm_value", "unit": "天"}', '1d', 1, 0, '{"OP":"<=", "VALUE":7}', gen_random_uuid());
...
INSERT INTO alarm_policy (
    ...
    threshold_error, lcuuid)
VALUES (
    1, 1, '过滤项: N/A | 分组项: *', '', '/v1/alarm/license-7days/', '{}', '[{"OPERATOR": {"return_field": "sysalarm_value", "return_field_description": "至少一个授权文件剩余有效期", "return_field_unit": "天"}}]', 'DeepFlow 授权即将过期', 1, 1, 1, 24, 1, '', '', '{"displayName":"sysalarm_value", "unit": "天"}', '1d', 1, 0, '{"OP":"<=", "VALUE":7}', gen_random_uuid());

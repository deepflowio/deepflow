...
VALUES (
    1, 1, '过滤项: N/A | 分组项: 控制器', '', '/v1/alarm/controller-lost/', '{}', '[{"OPERATOR": {"return_field": "sysalarm_value", "return_field_description": "最近 1 分钟失联次数", "return_field_unit": " 次"}}]', '控制器失联', 2, 1, 1, 20, 1, '', '', '{"displayName":"sysalarm_value", "unit": "次"}', '{"OP":">=","VALUE":1}', public.gen_random_uuid());
...
VALUES (
    1, 1, '过滤项: N/A | 分组项: 数据节点', '', '/v1/alarm/analyzer-lost/', '{}', '[{"OPERATOR": {"return_field": "sysalarm_value", "return_field_description": "最近 1 分钟失联次数", "return_field_unit": " 次"}}]', '数据节点失联',  2, 1, 1, 20, 1, '', '', '{"displayName":"sysalarm_value", "unit": "次"}', '{"OP":">=","VALUE":1}', public.gen_random_uuid());
...
VALUES (
    ...
    '[{"METRIC_LABEL":"disk_used_percent","return_field_description":"磁盘用量百分比","unit":"%"}]', '数据节点磁盘空间不足', 0, 1, 1, 21, 1, '', '', '{"displayName":"disk_used_percent", "unit": "%"}', '{"OP":">=","VALUE":70}', public.gen_random_uuid());
...
VALUES (
    ...
    '[{"METRIC_LABEL":"force_delete_clickhouse_data_bytes_on_disk","return_field_description":"最近 1 分钟数据节点数据强制删除","unit":"字节"}]', '数据节点数据强制删除', 0, 1, 1, 21, 1, '', '', '{"displayName":"force_delete_clickhouse_data_bytes_on_disk", "unit": "字节"}', '{"OP":">=","VALUE":1}', public.gen_random_uuid());
...
VALUES (
    ...
    '[{"METRIC_LABEL":"rx_drop_packets","return_field_description":"最近 1 分钟 ingester.recviver.metrics.invalid","unit":""}]', '数据节点数据丢失 (ingester.recviver.metrics.invalid)', 0, 1, 1, 21, 1, '', '', '{"displayName":"ingester.recviver.metrics.invalid", "unit": ""}', '{"OP":">=","VALUE":1}', public.gen_random_uuid());
...
VALUES (
    ...
    '[{"METRIC_LABEL":"rx_drop_packets","return_field_description":"最近 1 分钟 ingester.queue.metrics.overwritten","unit":""}]', '数据节点数据丢失 (ingester.queue.metrics.overwritten)', 0, 1, 1, 21, 1, '', '', '{"displayName":"ingester.queue.metrics.overwritten", "unit": ""}', '{"OP":">=","VALUE":1}', public.gen_random_uuid());
...
VALUES (
    ...
    '[{"METRIC_LABEL":"rx_drop_packets","return_field_description":"最近 1 分钟 ingester.decoder.metrics.drop_count","unit":""}]', '数据节点数据丢失 (ingester.decoder.metrics.drop_count)', 0, 1, 1, 21, 1, '', '', '{"displayName":"ingester.decoder.metrics.drop_count", "unit": ""}', '{"OP":">=","VALUE":1}', public.gen_random_uuid());
...
VALUES (
    ...
    '[{"METRIC_LABEL":"rx_drop_packets","return_field_description":"最近 1 分钟 ingester.ckwriter.metrics.write_failed_count","unit":""}]', '数据节点数据丢失 (ingester.ckwriter.metrics.write_failed_count)', 0, 1, 1, 21, 1, '', '', '{"displayName":"ingester.ckwriter.metrics.write_failed_count", "unit": ""}', '{"OP":">=","VALUE":1}', public.gen_random_uuid());
...
INSERT INTO alarm_policy (
    ...
    threshold_error, lcuuid)
VALUES (
    1, 1, '过滤项: N/A | 分组项: *', '', '/v1/alarm/voucher-30days/', '{}', '[{"OPERATOR": {"return_field": "sysalarm_value", "return_field_description": "余额预估可用天数", "return_field_unit": "天"}}]', 'DeepFlow 服务即将停止', 1, 1, 1, 24, 1, '', '', '{"displayName":"sysalarm_value", "unit": "天"}', '1d', 1, 0, '{"OP":"<=", "VALUE":30}', public.gen_random_uuid());
...
VALUES (
    1, 1, '过滤项: N/A | 分组项: *', '', '/v1/alarm/voucher-0days/', '{}', '[{"OPERATOR": {"return_field": "sysalarm_value", "return_field_description": "余额可用天数", "return_field_unit": "天"}}]', 'DeepFlow 服务停止', 2, 1, 1, 24, 1, '', '', '{"displayName":"sysalarm_value", "unit": "天"}', '1d', 1, 0, '{"OP":"<=", "VALUE":0}', public.gen_random_uuid());
...
INSERT INTO alarm_policy (
    ...
    threshold_error, lcuuid)
VALUES (
    1, 1, '过滤项: N/A | 分组项: *', '', '/v1/alarm/license-30days/', '{}', '[{"OPERATOR": {"return_field": "sysalarm_value", "return_field_description": "至少一个授权文件剩余有效期", "return_field_unit": "天"}}]', 'DeepFlow 授权即将过期', 1, 1, 1, 24, 1, '', '', '{"displayName":"sysalarm_value", "unit": "天"}', '1d', 1, 0, '{"OP":"<=", "VALUE":30}', public.gen_random_uuid());
...
INSERT INTO alarm_policy (
    ...
    threshold_critical, lcuuid)
VALUES (
    1, 1, '过滤项: N/A | 分组项: *', '', '/v1/alarm/license-0days/', '{}', '[{"OPERATOR": {"return_field": "sysalarm_value", "return_field_description": "至少一个授权文件剩余有效期", "return_field_unit": "天"}}]', 'DeepFlow 授权过期', 2, 1, 1, 24, 1, '', '', '{"displayName":"sysalarm_value", "unit": "天"}', '1d', 1, 0, '{"OP":"<=", "VALUE":0}', public.gen_random_uuid());
...
VALUES ('管理侧监控数据', 'deepflow_admin.*', 0, 7*24, public.gen_random_uuid());

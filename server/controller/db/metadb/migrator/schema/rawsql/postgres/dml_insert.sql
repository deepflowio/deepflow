INSERT INTO sys_configuration (id, param_name, value, comments, lcuuid) VALUES (1, 'cloud_sync_timer', '60', 'unit: s', public.gen_random_uuid());
INSERT INTO sys_configuration (id, param_name, value, comments, lcuuid) VALUES (2, 'pcap_data_retention', '3', 'unit: day', public.gen_random_uuid());
INSERT INTO sys_configuration (id, param_name, value, comments, lcuuid) VALUES (3, 'system_data_retention', '7', 'unit: day', public.gen_random_uuid());
INSERT INTO sys_configuration (id, param_name, value, comments, lcuuid) VALUES (4, 'ntp_servers', '0.cn.pool.ntp.org', '', public.gen_random_uuid());
...
VALUES (1, '网络-指标（秒级）', 'flow_metrics.network*', 1, 1 * 24, public.gen_random_uuid());
...
VALUES (2, '网络-指标（分钟级）', 'flow_metrics.network*', 1, 60, 7 * 24, 'Sum', 'Avg', public.gen_random_uuid());

INSERT INTO data_source (id, display_name, data_table_collection, interval_time, retention_time, query_time, lcuuid)
VALUES (6, '网络-流日志', 'flow_log.l4_flow_log', 0, 3 * 24, 6 * 60, public.gen_random_uuid());

INSERT INTO data_source (id, display_name, data_table_collection, interval_time, retention_time, lcuuid)
VALUES (7, '应用-指标（秒级）', 'flow_metrics.application*', 1, 1 * 24, public.gen_random_uuid());

INSERT INTO data_source (id, display_name, data_table_collection, base_data_source_id, interval_time, retention_time, summable_metrics_operator, unsummable_metrics_operator, lcuuid)
VALUES (8, '应用-指标（分钟级）', 'flow_metrics.application*', 7, 60, 7 * 24, 'Sum', 'Avg', public.gen_random_uuid());

INSERT INTO data_source (id, display_name, data_table_collection, interval_time, retention_time, query_time, lcuuid)
VALUES (9, '应用-调用日志', 'flow_log.l7_flow_log', 0, 3 * 24, 6 * 60, public.gen_random_uuid());

INSERT INTO data_source (id, display_name, data_table_collection, interval_time, retention_time, lcuuid)
VALUES (10, '网络-TCP 时序数据', 'flow_log.l4_packet', 0, 3 * 24, public.gen_random_uuid());

INSERT INTO data_source (id, display_name, data_table_collection, interval_time, retention_time, lcuuid)
VALUES (11, '网络-PCAP 数据', 'flow_log.l7_packet', 0, 3 * 24, public.gen_random_uuid());

INSERT INTO data_source (id, display_name, data_table_collection, interval_time, retention_time, lcuuid)
VALUES (12, '租户侧监控数据', 'deepflow_tenant.*', 0, 7 * 24, public.gen_random_uuid());

INSERT INTO data_source (id, display_name, data_table_collection, interval_time, retention_time, lcuuid)
VALUES (13, '外部指标数据', 'ext_metrics.*', 0, 7 * 24, public.gen_random_uuid());

INSERT INTO data_source (id, display_name, data_table_collection, interval_time, retention_time, lcuuid)
VALUES (14, 'Prometheus 数据', 'prometheus.*', 0, 7 * 24, public.gen_random_uuid());

INSERT INTO data_source (id, display_name, data_table_collection, interval_time, retention_time, lcuuid)
VALUES (15, '事件-资源变更事件', 'event.event', 0, 30 * 24, public.gen_random_uuid());

INSERT INTO data_source (id, display_name, data_table_collection, interval_time, retention_time, lcuuid)
VALUES (16, '事件-文件读写事件', 'event.file_event', 0, 7 * 24, public.gen_random_uuid());

INSERT INTO data_source (id, display_name, data_table_collection, interval_time, retention_time, lcuuid)
VALUES (17, '事件-告警事件', 'event.alert_event', 0, 30 * 24, public.gen_random_uuid());

INSERT INTO data_source (id, display_name, data_table_collection, interval_time, retention_time, lcuuid)
VALUES (18, '应用-性能剖析', 'profile.in_process', 0, 3 * 24, public.gen_random_uuid());

INSERT INTO data_source (id, display_name, data_table_collection, interval_time, retention_time, lcuuid)
VALUES (19, '网络-网络策略', 'flow_metrics.traffic_policy', 60, 3 * 24, public.gen_random_uuid());

INSERT INTO data_source (id, display_name, data_table_collection, interval_time, retention_time, query_time, lcuuid)
VALUES (20, '日志-日志数据', 'application_log.log', 1, 30 * 24, 6 * 60, public.gen_random_uuid());

INSERT INTO data_source (id, display_name, data_table_collection, base_data_source_id, interval_time, retention_time, summable_metrics_operator, unsummable_metrics_operator, lcuuid)
VALUES (21, '网络-指标（小时级）', 'flow_metrics.network*', 2, 3600, 30 * 24, 'Sum', 'Avg', public.gen_random_uuid());

INSERT INTO data_source (id, display_name, data_table_collection, base_data_source_id, interval_time, retention_time, summable_metrics_operator, unsummable_metrics_operator, lcuuid)
VALUES (22, '网络-指标（天级）', 'flow_metrics.network*', 21, 86400, 30 * 24, 'Sum', 'Avg', public.gen_random_uuid());

INSERT INTO data_source (id, display_name, data_table_collection, base_data_source_id, interval_time, retention_time, summable_metrics_operator, unsummable_metrics_operator, lcuuid)
VALUES (23, '应用-指标（小时级）', 'flow_metrics.application*', 8, 3600, 30 * 24, 'Sum', 'Avg', public.gen_random_uuid());

INSERT INTO data_source (id, display_name, data_table_collection, base_data_source_id, interval_time, retention_time, summable_metrics_operator, unsummable_metrics_operator, lcuuid)
VALUES (24, '应用-指标（天级）', 'flow_metrics.application*', 23, 86400, 30 * 24, 'Sum', 'Avg', public.gen_random_uuid());
...
VALUES (25, '应用-性能剖析指标', 'profile.in_process_metrics', 1, 3 * 24, 'Sum', 'Avg', public.gen_random_uuid());

INSERT INTO data_source (id, display_name, data_table_collection, interval_time, retention_time, summable_metrics_operator, unsummable_metrics_operator, lcuuid)
VALUES (26, '事件-文件读写指标', 'event.file_event_metrics', 1, 7 * 24, 'Sum', 'Avg', public.gen_random_uuid());
INSERT INTO data_source (id, display_name, data_table_collection, interval_time, retention_time, lcuuid)
VALUES (27, '事件-文件读写聚合事件', 'event.file_agg_event', 0, 7 * 24, public.gen_random_uuid());
INSERT INTO data_source (id, display_name, data_table_collection, interval_time, retention_time, lcuuid)
VALUES (28, '事件-文件管理事件', 'event.file_mgmt_event', 0, 7 * 24, public.gen_random_uuid());
INSERT INTO data_source (id, display_name, data_table_collection, interval_time, retention_time, lcuuid)
VALUES (29, '事件-进程权限事件', 'event.proc_perm_event', 0, 7 * 24, public.gen_random_uuid());
INSERT INTO data_source (id, display_name, data_table_collection, interval_time, retention_time, lcuuid)
VALUES (30, '事件-进程操作事件', 'event.proc_ops_event', 0, 7 * 24, public.gen_random_uuid());
INSERT INTO data_source (id, display_name, data_table_collection, interval_time, retention_time, lcuuid)
VALUES (31, '事件-进程阻断事件', 'event.proc_block_event', 0, 7 * 24, public.gen_random_uuid());
...
VALUES ('云网络', 3, 768, public.gen_random_uuid());
...
VALUES (
    1, 1, '过滤项: N/A | 分组项: 采集器', '', '/v1/alarm/vtap-lost/', '{}', '[{"OPERATOR": {"return_field": "sysalarm_value", "return_field_description": "最近 1 分钟失联次数", "return_field_unit": " 次"}}]', '采集器失联', 1, 1, 1, 20, 1, '', '', '{"displayName":"sysalarm_value", "unit": "次"}', '{"OP":">=", "VALUE":1}', public.gen_random_uuid()::text);
...
VALUES (
    1, 1, '过滤项: N/A | 分组项: 采集器', '', '/v1/alarm/vtap-exception/', '{}', '[{"OPERATOR": {"return_field": "sysalarm_value", "return_field_description": "最近 1 分钟异常状态个数", "return_field_unit": " 个"}}]', '采集器异常',  1, 1, 1, 20, 1, '', '', '{"displayName":"sysalarm_value", "unit": "个"}', '{"OP":">=","VALUE":1}', public.gen_random_uuid()::text);
...
VALUES (
    ...
    '[{"METRIC_LABEL":"cpu_usage","return_field_description":"持续 5 分钟 (CPU用量/阈值)","unit":"%"}]', '采集器 CPU 超限',  0, 1, 1, 21, 1, '', '', '{"displayName":"cpu_usage", "unit": "%"}', '{"OP":">=","VALUE":70}', '5m', public.gen_random_uuid()::text);
...
VALUES (
    ...
    '[{"METRIC_LABEL":"used_bytes","return_field_description":"持续 5 分钟 (内存用量/阈值)","unit":"%"}]', '采集器内存超限',  0, 1, 1, 21, 1, '', '', '{"displayName":"used_bytes", "unit": "%"}', '{"OP":">=","VALUE":70}', '5m', public.gen_random_uuid()::text);
...
VALUES (
    ...
    '[{"METRIC_LABEL":"process_start","return_field_description":"最近 1 分钟进程启动时间变化","unit":" 毫秒"}]', '采集器重启',  0, 1, 1, 20, 1, '', '', '{"displayName":"process_start_time_delta", "unit": "毫秒"}', 1, '{"OP":">=","VALUE":1}', public.gen_random_uuid()::text);
...
INSERT INTO alarm_policy (
    ...
    threshold_warning, lcuuid)
VALUES (
    1, 1, '过滤项: N/A | 分组项: *', '', '/v1/alarm/policy-event/', '{}', '[{"OPERATOR": {"return_field": "sysalarm_value", "return_field_description": "最近 1 分钟无效策略自动删除条数", "return_field_unit": "次"}}]', '无效策略自动删除',  0, 1, 1, 22, 1, '', '', '{"displayName":"sysalarm_value", "unit": "次"}', 1, '{"OP":">=","VALUE":1}', public.gen_random_uuid()::text);
...
VALUES (
    1, 1, '过滤项: N/A | 分组项: *', '', '/v1/alarm/platform-event/', '{}', '[{"OPERATOR": {"return_field": "sysalarm_value", "return_field_description": "最近 1 分钟云资源同步异常次数", "return_field_unit": "次"}}]', '云资源同步异常',  1, 1, 1, 23, 1, '', '', '{"displayName":"sysalarm_value", "unit": "次"}', '{"OP":">=","VALUE":1}', public.gen_random_uuid()::text);
...
VALUES (
    ...
    '[{"METRIC_LABEL":"log_counter_warning","return_field_description":"最近 1 分钟 WARN 日志总条数","unit":" 条"}]', '采集器 WARN 日志过多',  0, 1, 1, 20, 1, '', '', '{"displayName":"log_counter_warning", "unit": "条"}', '{"OP":">=","VALUE":1}', public.gen_random_uuid()::text);
...
VALUES (
    ...
    '[{"METRIC_LABEL":"log_counter_error","return_field_description":"最近 1 分钟 ERR 日志总条数","unit":" 条"}]', '采集器 ERR 日志过多',  1, 1, 1, 20, 1, '', '', '{"displayName":"log_counter_error", "unit": "条"}', '{"OP":">=","VALUE":1}', public.gen_random_uuid()::text);
...
VALUES (
    ...
    '[{"METRIC_LABEL":"delay","return_field_description":"资源同步滞后时间","unit":" 秒"}]', 'K8s 资源同步滞后',  1, 1, 1, 23, 1, '', '', '{"displayName":"delay", "unit": "秒"}', '{"OP":">=","VALUE":600}', public.gen_random_uuid()::text);
...
VALUES (
    ...
    '采集器数据丢失 (dispatcher.metrics.kernel_drops)',  0, 1, 1, 21, 1, '', '', '{"displayName":"dispatcher.metrics.kernel_drops", "unit": ""}', '{"OP":">=","VALUE":1}', public.gen_random_uuid()::text);
...
VALUES (
    ...
    '采集器数据丢失 (queue.metrics.overwritten)',  0, 1, 1, 21, 1, '', '', '{"displayName":"queue.metrics.overwritten", "unit": ""}', '{"OP":">=","VALUE":1}', public.gen_random_uuid()::text);
...
VALUES (
    ...
    '采集器数据丢失 (l7_session_aggr.metrics.throttle-drop)',  0, 1, 1, 21, 1, '', '', '{"displayName":"l7_session_aggr.metrics.throttle-drop", "unit": ""}', '{"OP":">=","VALUE":1}', public.gen_random_uuid()::text);
...
VALUES (
    ...
    '采集器数据丢失 (flow_aggr.metrics.drop-in-throttle)',  0, 1, 1, 21, 1, '', '', '{"displayName":"flow_aggr.metrics.drop-in-throttle", "unit": ""}', '{"OP":">=","VALUE":1}', public.gen_random_uuid()::text);
...
VALUES (
    ...
    '采集器数据丢失 (ebpf_collector.metrics.kern_lost)',  0, 1, 1, 21, 1, '', '', '{"displayName":"ebpf_collector.metrics.kern_lost", "unit": ""}', '{"OP":">=","VALUE":1}', public.gen_random_uuid()::text);
...
VALUES (
    ...
    '采集器数据丢失 (ebpf_collector.metrics.user_enqueue_lost)',  0, 1, 1, 21, 1, '', '', '{"displayName":"ebpf_collector.metrics.user_enqueue_lost", "unit": ""}', '{"OP":">=","VALUE":1}', public.gen_random_uuid()::text);
...
VALUES (
    ...
    '采集器数据丢失 (dispatcher.metrics.invalid_packets)',  0, 1, 1, 21, 1, '', '', '{"displayName":"dispatcher.metrics.invalid_packets", "unit": ""}', '{"OP":">=","VALUE":1}', public.gen_random_uuid()::text);
...
VALUES (
    ...
    '采集器数据丢失 (dispatcher.metrics.err)',  0, 1, 1, 21, 1, '', '', '{"displayName":"dispatcher.metrics.err", "unit": ""}', '{"OP":">=","VALUE":1}', public.gen_random_uuid()::text);
...
VALUES (
    ...
    '采集器数据丢失 (flow_map.metrics.drop_by_window)',  0, 1, 1, 21, 1, '', '', '{"displayName":"flow_map.metrics.drop_by_window", "unit": ""}', '{"OP":">=","VALUE":1}', (SELECT public.gen_random_uuid()));
...
VALUES (
    ...
    '采集器数据丢失 (flow_map.metrics.drop_by_capacity)',  0, 1, 1, 21, 1, '', '', '{"displayName":"flow_map.metrics.drop_by_capacity", "unit": ""}', '{"OP":">=","VALUE":1}', (SELECT public.gen_random_uuid()));
...
VALUES (
    ...
    '采集器数据丢失 (flow_aggr.metrics.drop-before-window)',  0, 1, 1, 21, 1, '', '', '{"displayName":"flow_aggr.metrics.drop-before-window", "unit": ""}', '{"OP":">=","VALUE":1}', (SELECT public.gen_random_uuid()));
...
VALUES (
    ...
    '采集器数据丢失 (quadruple_generator.metrics.drop-before-window)',  0, 1, 1, 21, 1, '', '', '{"displayName":"quadruple_generator.metrics.drop-before-window", "unit": ""}', '{"OP":">=","VALUE":1}', (SELECT public.gen_random_uuid()));
...
VALUES (
    ...
    '采集器数据丢失 (collector.metrics.drop-before-window)',  0, 1, 1, 21, 1, '', '', '{"displayName":"collector.metrics.drop-before-window", "unit": ""}', '{"OP":">=","VALUE":1}', (SELECT public.gen_random_uuid()));
...
VALUES (
    ...
    '采集器数据丢失 (collector.metrics.drop-inactive)',  0, 1, 1, 21, 1, '', '', '{"displayName":"collector.metrics.drop-inactive", "unit": ""}', '{"OP":">=","VALUE":1}', (SELECT public.gen_random_uuid()));
...
VALUES (
    ...
    '采集器数据丢失 (collect_sender.metrics.dropped)',  0, 1, 1, 21, 1, '', '', '{"displayName":"collect_sender.metrics.dropped", "unit": ""}', '{"OP":">=","VALUE":1}', (SELECT public.gen_random_uuid()));
...
VALUES (
    ...
    '云资源关联关系异常 (实例与IP)',  0, 1, 1, 1, '{"displayName":"Sum(metrics.count)","unit":""}', '{"OP":">=","VALUE":1}', (SELECT public.gen_random_uuid()));
...
VALUES (
    ...
    '云资源关联关系异常 (云主机与容器节点)',  0, 1, 1, 1, '{"displayName":"Sum(metrics.count)","unit":""}', '{"OP":">=","VALUE":1}', (SELECT public.gen_random_uuid()));
...
VALUES (
    ...
    '云资源同步滞后 (云主机)',  0, 1, 1, 1, '{"displayName":"Max(metrics.max_delay)","unit":""}', '{"OP":">=","VALUE":150}', (SELECT public.gen_random_uuid()));
...
VALUES (
    ...
    '云资源同步滞后 (POD)',  0, 1, 1, 1, '{"displayName":"Max(metrics.max_delay)","unit":""}', '{"OP":">=","VALUE":120}', (SELECT public.gen_random_uuid()));
...
VALUES (
    ...
    '云资源同步滞后 (API 调用)',  0, 1, 1, 1, '{"displayName":"AAvg(metrics.cost)","unit":""}', '{"OP":">=","VALUE":300}', (SELECT public.gen_random_uuid()));

...
var VTapTypeName = map[int]string{
	...
	VTAP_TYPE_POD_HOST:             "VTAP_TYPE_POD_HOST",
	VTAP_TYPE_POD_VM:               "VTAP_TYPE_POD_VM",
	VTAP_TYPE_TUNNEL_DECAPSULATION: "VTAP_TYPE_TUNNEL_DECAPSULATION",
	VTAP_TYPE_HYPER_V:              "VTAP_TYPE_HYPER_V",
}

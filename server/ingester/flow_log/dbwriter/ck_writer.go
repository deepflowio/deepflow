...
import (
	...
	flowlogconfig "github.com/deepflowys/deepflow/server/ingester/flow_log/config"
	logdata "github.com/deepflowys/deepflow/server/ingester/flow_log/log_data"
...
func NewFlowLogWriter(addr, user, password, cluster, storagePolicy string, ckWriterCfg config.CKWriterConfig, flowLogTtl flowlogconfig.FlowLogTTL, coldStorages map[string]*ckdb.ColdStorage) (*FlowLogWriter, error) {

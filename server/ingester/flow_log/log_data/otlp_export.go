...
func (l7 *L7FlowLog) QueryUniversalTags(utags *utag.UniversalTagsManager) (utag.UniversalTags, utag.UniversalTags) {
	return utags.QueryUniversalTags(
			...
			l7.L3DeviceID1, l7.AutoServiceID1, l7.AutoInstanceID1, l7.PodNodeID1, l7.PodGroupID1, l7.PodID1, uint32(l7.L3EpcID0), l7.GPID0, l7.ServiceID0,
			l7.IsIPv4, l7.IP41, l7.IP61,
		)
}

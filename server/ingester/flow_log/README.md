...
|          | 采集点               | capture_network_type | integer | 有 |    | 3: 虚拟网络, 其他: 非虚拟网络                    |
|          | 采集网口标识         | capture_nic     | string   |      |      | 显示为八个字符的16进制如`01234567`               |
|          |                      |                 |          |      |      | capture_network_type不等于3时, 接入网络流量源，表示dispatcherID: 00000000~00000000F |
|          |                      |                 |          |      |      | capture_network_type等于3时, 虚拟网络采集器流量源，表示虚拟接口MAC地址低4字节: 00000000~FFFFFFFF |

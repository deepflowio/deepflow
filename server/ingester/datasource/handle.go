...
const (
	...
	EVENT_FILE_AGG_EVENT                          = "event.file_agg_event"
	EVENT_FILE_MGMT_EVENT                         = "event.file_mgmt_event"
	EVENT_PROC_PERM_EVENT                         = "event.proc_perm_event"
	EVENT_PROC_OPS_EVENT                          = "event.proc_ops_event"
	EVENT_PROC_BLOCK_EVENT                        = "event.proc_block_event"
...
var DatasourceModifiedOnlyIDMap = map[DatasourceModifiedOnly]DatasourceInfo{
	...
	EVENT_FILE_AGG_EVENT:   {int(flow_metrics.METRICS_TABLE_ID_MAX) + 10, "event", []string{"file_agg_event"}, []string{}},
	EVENT_FILE_MGMT_EVENT:  {int(flow_metrics.METRICS_TABLE_ID_MAX) + 11, "event", []string{"file_mgmt_event"}, []string{}},
	EVENT_PROC_PERM_EVENT:  {int(flow_metrics.METRICS_TABLE_ID_MAX) + 12, "event", []string{"proc_perm_event"}, []string{}},
	EVENT_PROC_OPS_EVENT:   {int(flow_metrics.METRICS_TABLE_ID_MAX) + 13, "event", []string{"proc_ops_event"}, []string{}},
	EVENT_ALERT_EVENT:      {int(flow_metrics.METRICS_TABLE_ID_MAX) + 14, "event", []string{"alert_event", "alert_record"}, []string{}},
	PROFILE:                {int(flow_metrics.METRICS_TABLE_ID_MAX) + 15, "profile", []string{"in_process"}, []string{}},
	APPLOG:                 {int(flow_metrics.METRICS_TABLE_ID_MAX) + 16, "application_log", []string{"log"}, []string{}},
	DEEPFLOW_TENANT:        {int(flow_metrics.METRICS_TABLE_ID_MAX) + 17, "deepflow_tenant", []string{"deepflow_collector"}, []string{}},
	DEEPFLOW_ADMIN:         {int(flow_metrics.METRICS_TABLE_ID_MAX) + 18, "deepflow_admin", []string{"deepflow_server"}, []string{}},
	PROFILE_METRICS:        {int(flow_metrics.METRICS_TABLE_ID_MAX) + 19, "profile", []string{"in_process_metrics.1s_agg"}, []string{}},
	FILE_EVNET_METRICS:     {int(flow_metrics.METRICS_TABLE_ID_MAX) + 20, "event", []string{"file_event_metrics.1s_agg"}, []string{}},
	EVENT_PROC_BLOCK_EVENT: {int(flow_metrics.METRICS_TABLE_ID_MAX) + 21, "event", []string{"proc_block_event"}, []string{}},
}

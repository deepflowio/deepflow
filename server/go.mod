...
replace (
	...
	github.com/deepflowio/deepflow/server/controller/db/mysql/edition => ./controller/db/mysql/edition
...
require (
	...
	github.com/deepflowio/deepflow/server/controller/db/mysql/edition v0.0.0-00010101000000-000000000000

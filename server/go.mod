...
replace (
	...
	github.com/deepflowio/deepflow/server/controller/genesis/store2/sync => ./controller/genesis/store2/sync
...
require (
	...
	github.com/deepflowio/deepflow/server/controller/genesis/store2/sync v0.0.0-00010101000000-000000000000

...
type ProcessMatcher struct {
	...
	MatchLanguages  []string `yaml:"match_languages,omitempty"`
	MatchUsernames  []string `yaml:"match_usernames,omitempty"`
	OnlyInContainer bool     `yaml:"only_in_container,omitempty"`
	OnlyWithTag     bool     `yaml:"only_with_tag,omitempty"`
	Ignore          bool     `yaml:"ignore,omitempty"`
	RewriteName     string   `yaml:"rewrite_name,omitempty"`
...
type BondInterfaceSlave struct {
...
type AfPacket struct {
	...
	BondInterfaces                 []BondInterfaceSlave `yaml:"bond_interfaces,omitempty"`
...
type Socket struct {
	...
	PcapSocketType            string `yaml:"pcap_socket_type,omitempty"`
...
type TagFilterOperator struct {
	Name     string `yaml:"field_name,omitempty"`

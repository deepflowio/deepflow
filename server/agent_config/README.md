  ...
  request_characters:  # Multiple features are ORed
    - character: # Multiple match_keywords are ANDed
      - match_keyword: abc  # Feature string
        match_type: "string" # Possible values: "string", "istring", "hex"
...
- policy_name: "my_policy" # name of current policy
  ...
  fields:
  - field_name: "my_field"
    field_match_type: "string"  # optional values: "string"/"istring"(case-insensitive)
    ...
    metric_type: "int"  # default value is int, optional values: int/float
```

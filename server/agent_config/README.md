...
Configuring to 0 means disabling the threshold.
The observed disk is the disk where the `global.circuit_breakers.free_disk.directory` directory is located.
...
#### Directory {#global.circuit_breakers.free_disk.directory}
...
`global.circuit_breakers.free_disk.directory`
...
Observe the disk space where the directory is located.

...
const TABLE_NAME_FILE_AGG_EVENT = "file_agg_event"
const TABLE_NAME_FILE_MGMT_EVENT = "file_mgmt_event"
const TABLE_NAME_PROC_PERM_EVENT = "proc_perm_event"
const TABLE_NAME_PROC_OPS_EVENT = "proc_ops_event"
const TABLE_NAME_PROC_BLOCK_EVENT = "proc_block_event"
...
var DB_TABLE_MAP = map[string][]string{
	...
	DB_NAME_EVENT:           []string{"event", "file_event", TABLE_NAME_FILE_AGG_EVENT, TABLE_NAME_FILE_MGMT_EVENT, TABLE_NAME_PROC_PERM_EVENT, TABLE_NAME_PROC_OPS_EVENT, TABLE_NAME_PROC_BLOCK_EVENT, TABLE_NAME_ALERT_EVENT, TABLE_NAME_ALERT_RECORD, TABLE_NAME_FILE_EVENT_METRICS},

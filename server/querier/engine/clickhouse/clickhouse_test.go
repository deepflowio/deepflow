...
var (
	parseSQL = []struct {
		...
		output: []string{"WITH if(l3_device_type_1 = 1, l3_device_type_1, 0) AS `device_type_chost_1`, if(l3_device_type_1 = 15, l3_device_type_1, 0) AS `device_type_lb_1` SELECT dictGet('flow_tag.region_map', 'name', (toUInt64(region_id_0))) AS `region_0`, dictGet('flow_tag.device_map', 'name', (toUInt64(device_type_chost_1),toUInt64(l3_device_id_1))) AS `chost_1`, dictGet('flow_tag.device_map', 'name', (toUInt64(device_type_lb_1),toUInt64(l3_device_id_1))) AS `lb_1`, MAX(byte_tx+byte_rx) AS `max_byte` FROM flow_log.`l4_flow_log` PREWHERE (l3_device_id_1!=0 AND l3_device_type_1=1) AND (l3_device_id_1!=0 AND l3_device_type_1=15) GROUP BY `region_id_0`, `l3_device_id_1`, `device_type_chost_1`, `device_type_lb_1` LIMIT 1"},
	}, {
		...
		output: []string{"SELECT region_id_0, if(l3_device_type_1=1,l3_device_id_1, 0) AS `chost_id_1` FROM flow_log.`l7_flow_log` PREWHERE (l3_device_id_1!=0 AND l3_device_type_1=1) GROUP BY `region_id_0`, `chost_id_1` LIMIT 10000"},
	}, {
		input:  "SELECT ip_0 FROM l4_flow_log WHERE  ((is_internet_1=1) OR (is_internet_0=1)) GROUP BY ip_0 limit 1",
		output: []string{"SELECT if(is_ipv4=1, IPv4NumToString(ip4_0), IPv6NumToString(ip6_0)) AS `ip_0` FROM flow_log.`l4_flow_log` PREWHERE (((l3_epc_id_1 = -2)) OR ((l3_epc_id_0 = -2))) GROUP BY `is_ipv4`, `ip4_0`, `ip6_0` LIMIT 1"},
	}, {
		...
		output: []string{"SELECT if(type IN [0, 2],1,0) AS `request` FROM flow_log.`l7_flow_log` PREWHERE (observation_point GLOBAL IN (SELECT value FROM flow_tag.string_enum_map WHERE name_en = 'xxx' and tag_name='observation_point') OR observation_point = 'xxx') LIMIT 0, 50"},
	}, {
		input:  "select request from l7_flow_log where Enum(tap_side) like 'xxx' limit 0, 50",
		output: []string{"SELECT if(type IN [0, 2],1,0) AS `request` FROM flow_log.`l7_flow_log` PREWHERE (observation_point GLOBAL IN (SELECT value FROM flow_tag.string_enum_map WHERE name_en ilike 'xxx' and tag_name='observation_point')) LIMIT 0, 50"},
	}, {
		...
		output: []string{"SELECT dictGet('flow_tag.pod_ns_map', 'name', (toUInt64(pod_ns_id))) AS `pod_ns`, topK(10)(dictGet('flow_tag.pod_map', 'name', (toUInt64(pod_id)))) FROM flow_metrics.`application.1h` WHERE `time` >= 1687315761 AND `time` <= 1687316661 AND (pod_ns_id!=0) GROUP BY `pod_ns_id` LIMIT 10"},
	}, {
		name:   "topk_2",
		db:     "flow_metrics",
		...
		output: []string{"SELECT dictGet('flow_tag.pod_ns_map', 'name', (toUInt64(pod_ns_id))) AS `pod_ns`, topK(10)((dictGet('flow_tag.pod_map', 'name', (toUInt64(pod_id))),pod_cluster_id,service_id)) FROM flow_metrics.`application.1h` WHERE `time` >= 1694069050 AND `time` <= 1694990640 AND (pod_ns_id!=0) GROUP BY `pod_ns_id` LIMIT 10"},
	}, {
		name:   "topk_enum",
		db:     "flow_log",
		...
		output: []string{"SELECT dictGet('flow_tag.pod_ns_map', 'name', (toUInt64(pod_ns_id))) AS `pod_ns`, any(dictGet('flow_tag.pod_map', 'name', (toUInt64(pod_id)))) FROM flow_metrics.`application.1h` WHERE `time` >= 1694069050 AND `time` <= 1694990640 AND (pod_ns_id!=0) GROUP BY `pod_ns_id` LIMIT 10"},
	}, {
		name:   "any_2",
		db:     "flow_metrics",
		...
		output: []string{"SELECT dictGet('flow_tag.pod_ns_map', 'name', (toUInt64(pod_ns_id))) AS `pod_ns`, any((dictGet('flow_tag.pod_map', 'name', (toUInt64(pod_id))),pod_cluster_id,service_id)) FROM flow_metrics.`application.1h` WHERE `time` >= 1694069050 AND `time` <= 1694990640 AND (pod_ns_id!=0) GROUP BY `pod_ns_id` LIMIT 10"},
	}, {
		...
		output:     []string{"WITH if(l3_device_type_0=1, dictGet('flow_tag.device_map', 'icon_id', (toUInt64(1),toUInt64(l3_device_id_0))), 0) AS `client_icon_id`, if(l3_device_type_0 = 1, l3_device_type_0, 0) AS `device_type_chost_hostname_0`, if(l3_device_type_0 = 1, l3_device_type_0, 0) AS `device_type_chost_ip_0` SELECT dictGet('flow_tag.region_map', 'name', (toUInt64(region_id_0))) AS `region_0`, if(l3_device_type_0=1,l3_device_id_0, 0) AS `chost_hostname_id_0`, if(l3_device_type_0=1,l3_device_id_0, 0) AS `chost_ip_id_0`, dictGet('flow_tag.device_map', 'hostname', (toUInt64(device_type_chost_hostname_0),toUInt64(l3_device_id_0))) AS `chost_hostname_0`, dictGet('flow_tag.device_map', 'ip', (toUInt64(device_type_chost_ip_0),toUInt64(l3_device_id_0))) AS `chost_ip_0`, 'chost', 'chost' AS `client_node_type`, `client_icon_id` FROM flow_metrics.`network_map.1m` PREWHERE `time` >= 1705040184 AND `time` <= 1705045184 AND (not(toUInt64(l3_device_id_0) GLOBAL IN (SELECT deviceid FROM flow_tag.device_map WHERE hostname = 'a' AND devicetype=1) AND l3_device_type_0=1)) AND (not(l3_device_id_0 = 1 AND l3_device_type_0=1)) AND (not(l3_device_id_0 = 2 AND l3_device_type_0=1)) AND (l3_device_id_0!=0 AND l3_device_type_0=1) AND (l3_device_id_0!=0 AND l3_device_type_0=1) AND (l3_device_id_0!=0 AND l3_device_type_0=1) AND (l3_device_id_0!=0 AND l3_device_type_0=1) GROUP BY `client_icon_id`, `region_id_0`, `chost_hostname_id_0`, `chost_ip_id_0`, `l3_device_id_0`, `device_type_chost_hostname_0`, `device_type_chost_ip_0` LIMIT 5"},
	}, {
		...
		output:     []string{"WITH dictGet('flow_tag.pod_node_map', 'icon_id', (toUInt64(pod_node_id_0))) AS `client_icon_id`, dictGet('flow_tag.pod_node_map', 'icon_id', (toUInt64(pod_node_id_1))) AS `server_icon_id` SELECT pod_node_id_1 AS `pod_node_hostname_id_1`, pod_node_id_0 AS `pod_node_ip_id_0`, dictGet('flow_tag.device_map', 'hostname', (toUInt64(14),toUInt64(pod_node_id_1))) AS `pod_node_hostname_1`, dictGet('flow_tag.device_map', 'ip', (toUInt64(14),toUInt64(pod_node_id_0))) AS `pod_node_ip_0`, 'pod_node' AS `client_node_type`, 'pod_node' AS `server_node_type`, `client_icon_id`, `server_icon_id` FROM flow_metrics.`network_map.1m` PREWHERE `time` >= 1705040184 AND `time` <= 1705045184 AND (not(toUInt64(pod_node_id_1) GLOBAL IN (SELECT deviceid FROM flow_tag.device_map WHERE hostname = 'a' AND devicetype=14))) AND (not(pod_node_id_1 = 1)) AND (not(pod_node_id_1 = 2)) AND (pod_node_id_1!=0) AND (pod_node_id_0!=0) AND (pod_node_id_1!=0) AND (pod_node_id_0!=0) GROUP BY `pod_node_id_1`, `pod_node_id_0` LIMIT 5"},
	}, {
		...
		output:     []string{"SELECT dictGet('flow_tag.region_map', 'name', (toUInt64(region_id))) AS `region` FROM flow_metrics.`network.1m` PREWHERE `time` >= 1705040184 AND `time` <= 1705045184 AND (host_id!=0) GROUP BY `region_id` LIMIT 5"},
	}, {
		...
		output:     []string{"SELECT dictGet('flow_tag.region_map', 'name', (toUInt64(region_id_0))) AS `region_0` FROM flow_metrics.`network_map.1m` PREWHERE `time` >= 1705040184 AND `time` <= 1705045184 AND (l3_device_id_0!=0 AND l3_device_type_0=1) GROUP BY `region_id_0` LIMIT 5"},
	}, {
		name:   "test_show_1",
		db:     "flow_metrics",

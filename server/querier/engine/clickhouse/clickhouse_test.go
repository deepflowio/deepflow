...
var (
	parseSQL = []struct {
		...
		output: "SELECT if(resource_gl0_type_0 in (0,255),if(is_ipv4=1, IPv4NumToString(ip4_0), IPv6NumToString(ip6_0)),dictGet(flow_tag.device_map, 'name', (toUInt64(resource_gl0_type_0),toUInt64(resource_gl0_id_0)))) AS `resource_gl0_0`, if(is_ipv4=1, IPv4NumToString(ip4_0), IPv6NumToString(ip6_0)) AS `ip_0`, resource_gl0_type_0 FROM flow_log.`l7_flow_log` GROUP BY if(resource_gl0_type_0 in (0,255),if(is_ipv4=1, IPv4NumToString(ip4_0), IPv6NumToString(ip6_0)),dictGet(flow_tag.device_map, 'name', (toUInt64(resource_gl0_type_0),toUInt64(resource_gl0_id_0)))) AS `resource_gl0_0`, `resource_gl0_type_0`, if(is_ipv4=1, IPv4NumToString(ip4_0), IPv6NumToString(ip6_0)) AS `ip_0` LIMIT 10000",
	}, {
		...
		output: "SELECT dictGetOrDefault(flow_tag.k8s_labels_map, 'labels', toUInt64(pod_id_0),'{}') AS `labels_0` FROM flow_log.`l7_flow_log` LIMIT 10000",
	}, {

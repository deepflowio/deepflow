...
var (
	parseSQL = []struct {
		...
		output: "SELECT if(if(l3_device_type_0=11, dictGet(flow_tag.pod_service_k8s_label_map, 'value', (toUInt64(l3_device_id_0),'statefulset.kubernetes.io/pod-name')), '')!='',if(l3_device_type_0=11, dictGet(flow_tag.pod_service_k8s_label_map, 'value', (toUInt64(l3_device_id_0),'statefulset.kubernetes.io/pod-name')), ''), dictGet(flow_tag.pod_k8s_label_map, 'value', (toUInt64(pod_id_0),'statefulset.kubernetes.io/pod-name')) ) AS `k8s.label.statefulset.kubernetes.io/pod-name_0` FROM flow_log.`l4_flow_log` PREWHERE ((toUInt64(l3_device_id_0) IN (SELECT id FROM flow_tag.pod_service_k8s_label_map WHERE value = 'opensource-loki-0' and key='statefulset.kubernetes.io/pod-name') AND l3_device_type_0=11) OR (toUInt64(pod_id_0) IN (SELECT id FROM flow_tag.pod_k8s_label_map WHERE value = 'opensource-loki-0' and key='statefulset.kubernetes.io/pod-name'))) AND (((toUInt64(l3_device_id_0) IN (SELECT id FROM flow_tag.pod_service_k8s_label_map WHERE key='statefulset.kubernetes.io/pod-name') AND l3_device_type_0=11) OR (toUInt64(pod_id_0) IN (SELECT id FROM flow_tag.pod_k8s_label_map WHERE key='statefulset.kubernetes.io/pod-name')))) GROUP BY `k8s.label.statefulset.kubernetes.io/pod-name_0` LIMIT 10000",
	}, {
		...
		output: "SELECT if(if(l3_device_type_0=11, dictGet(flow_tag.pod_service_k8s_label_map, 'value', (toUInt64(l3_device_id_0),'statefulset.kubernetes.io/pod-name')), '')!='',if(l3_device_type_0=11, dictGet(flow_tag.pod_service_k8s_label_map, 'value', (toUInt64(l3_device_id_0),'statefulset.kubernetes.io/pod-name')), ''), dictGet(flow_tag.pod_k8s_label_map, 'value', (toUInt64(pod_id_0),'statefulset.kubernetes.io/pod-name')) ) AS `k8s.label.abc` FROM flow_log.`l4_flow_log` PREWHERE ((toUInt64(l3_device_id_0) IN (SELECT id FROM flow_tag.pod_service_k8s_label_map WHERE value = 'opensource-loki-0' and key='statefulset.kubernetes.io/pod-name') AND l3_device_type_0=11) OR (toUInt64(pod_id_0) IN (SELECT id FROM flow_tag.pod_k8s_label_map WHERE value = 'opensource-loki-0' and key='statefulset.kubernetes.io/pod-name'))) AND (((toUInt64(l3_device_id_0) IN (SELECT id FROM flow_tag.pod_service_k8s_label_map WHERE key='statefulset.kubernetes.io/pod-name') AND l3_device_type_0=11) OR (toUInt64(pod_id_0) IN (SELECT id FROM flow_tag.pod_k8s_label_map WHERE key='statefulset.kubernetes.io/pod-name')))) GROUP BY `k8s.label.abc` LIMIT 10000",
	}, {
		...
		output: "SELECT if(if(l3_device_type_0=11, dictGetOrDefault(flow_tag.pod_service_k8s_labels_map, 'labels', toUInt64(l3_device_id_0),'{}'), '{}')!='{}',if(l3_device_type_0=11, dictGetOrDefault(flow_tag.pod_service_k8s_labels_map, 'labels', toUInt64(l3_device_id_0),'{}'), '{}'), dictGetOrDefault(flow_tag.pod_k8s_labels_map, 'labels', toUInt64(pod_id_0),'{}'))  AS `k8s.label_0` FROM flow_log.`l7_flow_log` LIMIT 10000",
	}, {

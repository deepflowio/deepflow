...
rtt_server                  , 平均 TCP 建连服务端时延 , us , 采集周期内，所有 TCP 建连服务端时延的平均值，单次时延的计算见文档描述
srt                         , 平均 TCP/ICMP 系统时延  , us , 采集周期内，所有 TCP/ICMP 系统时延的平均值，单次时延的计算见文档描述
art                         , 平均数据时延            , us , 采集周期内，所有数据时延的平均值，数据时延包含 TCP/UDP，单次时延的计算见文档描述
cit                         , 平均客户端等待时延      , us , 采集周期内，所有客户端等待时延的平均值，数据时延仅包含 TCP，单次时延的计算见文档描述
rtt_max                     , 最大 TCP 建连时延       , us , 采集周期内，所有 TCP 建连时延的最大值，单次时延的计算见文档描述 
rtt_client_max              , 最大 TCP 建连客户端时延 , us , 采集周期内，所有 TCP 建连客户端时延的最大值，单次时延的计算见文档描述
rtt_server_max              , 最大 TCP 建连服务端时延 , us , 采集周期内，所有 TCP 建连服务端时延的最大值，单次时延的计算见文档描述
srt_max                     , 最大 TCP/ICMP 系统时延  , us , 采集周期内，所有 TCP/ICMP 系统时延的最大值，单次时延的计算见文档描述 
art_max                     , 最大数据时延            , us , 采集周期内，所有数据时延的最大值，数据时延包含 TCP/UDP，单次时延的计算见文档描述 
cit_max                     , 最大客户端等待时延      , us , 采集周期内，所有客户端等待时延的最大值，数据时延仅包含 TCP，单次时延的计算见文档描述 

l7_request                  , 应用请求                , 个   , 应用层协议请求次数
l7_response                 , 应用响应                , 个   , 应用层协议响应次数
rrt                         , 平均应用时延            , us , 采集周期内，所有应用时延的平均值，单次应用时延等于响应与请求的时间差
rrt_max                     , 最大应用时延            , us , 采集周期内，所有应用时延的最大值，单次应用时延等于响应与请求的时间差

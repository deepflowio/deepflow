...
pub struct Labeler {
    ...
    // CIDR表
    epc_cidr_masklen_table: RwLock<HashMap<i32, (u8, u8)>>,
    epc_cidr_table: RwLock<HashMap<EpcNetIpKey, Arc<Cidr>>>,
...
impl Default for Labeler {
    fn default() -> Self {
        Self {
            ...
            epc_cidr_masklen_table: RwLock::new(HashMap::new()),
...
impl Labeler {
    ...
    pub fn update_cidr_table(&mut self, cidrs: &Vec<Arc<Cidr>>) {
        ...
        let mut masklen_table: HashMap<i32, (u8, u8)> = HashMap::new();
        let mut epc_table: HashMap<EpcNetIpKey, Arc<Cidr>> = HashMap::new();

...
use super::{
    config::{
        ApiResources, ApplicationTimeout, Config, DpdkSource, ExtraLogFields, ExtraLogFieldsInfo,
        HttpEndpoint, HttpEndpointMatchRule, OracleConfig, PcapStream, PortConfig,
        ProcessorsFlowLogTunning, TagFilterOperator, UserConfig,
    },
...
impl Default for LogParserConfig {
    fn default() -> Self {
        Self {
            ...
            l7_log_session_aggr_max_timeout: ApplicationTimeout::DEFAULT,
...
impl ConfigHandler {
    ...
    pub fn on_config(
        ...
        if timeouts.applications != new_timeouts.applications {
            info!(
                "Update processors.request_log.timeouts.applications from {:?} to {:?}.",
                timeouts.applications, new_timeouts.applications
            );
            timeouts.applications = new_timeouts.applications.clone();
        }

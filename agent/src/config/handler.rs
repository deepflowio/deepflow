...
pub struct L7LogDynamicConfig {
    ...
    #[cfg(feature = "enterprise")]
    pub extra_segment_map: HashMap<L7ProtocolEnum, SegmentMap<usize>>,
    #[cfg(feature = "enterprise")]
    pub extra_field_policies: HashMap<L7ProtocolEnum, Vec<ExtraCustomFieldPolicy>>,
}
        ...
        impl PartialEq for L7LogDynamicConfig {
            fn eq(&self, other: &Self) -> bool {
                self.proxy_client == other.proxy_client
                    ...
                    && self.extra_segment_map == other.extra_segment_map
                    && self.extra_field_policies == other.extra_field_policies
            }
        }
    }
    else {
...
impl L7LogDynamicConfig {
    pub fn new(
        ...
        #[cfg(feature = "enterprise")] extra_segment_map: HashMap<
            L7ProtocolEnum,
            SegmentMap<usize>,
        >,
...
impl TryFrom<(Config, UserConfig)> for ModuleConfig {
    ...
    fn try_from(conf: (Config, UserConfig)) -> Result<Self, Self::Error> {
        ...
        #[cfg(feature = "enterprise")]
        let (extra_segment_map, extra_field_policies) = conf.get_extra_field_policies();

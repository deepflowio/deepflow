...
int bcc_symcache_resolve(void *symcache, uint64_t addr,
...
int bcc_resolve_global_addr(int pid, const char *module,
...
int bcc_buildsymcache_add_module(void *resolver,

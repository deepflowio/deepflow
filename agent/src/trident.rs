...
pub struct AgentComponents {
    ...
    pub l4_flow_uniform_sender: UniformSenderThread<RcedTaggedFlow>,
    ...
    pub l4_flow_aggr_sender: DebugSender<RcedTaggedFlow>,
...
impl AgentComponents {
    ...
    fn new_collector(
        ...
        l4_flow_aggr_sender: Option<DebugSender<RcedTaggedFlow>>,
...
fn build_dispatchers(
    ...
    gateway_vmac_addrs: Vec<MacAddr>,
    toa_info_sender: DebugSender<Box<(SocketAddr, SocketAddr)>>,
    l4_flow_aggr_sender: DebugSender<RcedTaggedFlow>,
    metrics_sender: DebugSender<BoxedDocument>,
    #[cfg(target_os = "linux")] netns: netns::NsFile,

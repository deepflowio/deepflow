...
mod tests {
    ...
    if #[cfg(feature = "enterprise")] {
            ...
            use public::segment_map::SegmentMap;
        }
    }
    ...
    fn test_parse_hessian2_payload() {
        ...
        segment_map.add_single(20080, vec![0usize; 1]);
        ...
        let config = L7LogDynamicConfig::new(
            ...
            ExtraLogFields::default(),
            false,
            HashMap::from([(L7ProtocolEnum::L7Protocol(L7Protocol::Dubbo), segment_map)]),
            HashMap::from([(
    ...
    fn test_parse_hessian2_payload_with_args() {
        ...
        let mut segment_map = SegmentMap::new();
        segment_map.add_single(20000, vec![0usize; 1]);
        segment_map.merge_segments();
        let config = L7LogDynamicConfig::new(
            vec![],
            vec!["x-request-id".into()],

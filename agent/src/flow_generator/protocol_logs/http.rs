...
impl HttpInfo {
    pub fn merge_custom_to_http(&mut self, custom: CustomInfo, dir: PacketDirection) {
        ...
        if let Some(x_request_id) = custom.trace.x_request_id {
            match dir {
                PacketDirection::ClientToServer => self.x_request_id_0 = x_request_id,
                PacketDirection::ServerToClient => self.x_request_id_1 = x_request_id,
            }
        }

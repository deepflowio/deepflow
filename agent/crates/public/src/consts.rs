...
pub const PROCESS_NAME: &str = "data-agent";
#[cfg(any(target_os = "linux", target_os = "android"))]
pub const PROCESS_NAME_SECONDARY: &str = "trident";
#[cfg(target_os = "windows")]
pub const PROCESS_NAME: &str = "data-agent.exe";
pub const DAEMONSET_NAME: &str = "data-agent";
pub const CONTAINER_NAME: &str = "data-agent";
...
pub const CGROUP_PROCS_PATH: &'static str = "cpu/data-agent/cgroup.procs";
pub const CGROUP_TASKS_PATH: &'static str = "cpu/data-agent/tasks";
pub const CGROUP_V2_PROCS_PATH: &'static str = "data-agent/cgroup.procs";
pub const CGROUP_V2_THREADS_PATH: &'static str = "data-agent/cgroup.threads";

#[cfg(target_os = "linux")]
mod platform_consts {
    pub const DEFAULT_LOG_FILE: &'static str = "/var/log/data-agent/data-agent.log";
    pub const DEFAULT_CONF_FILE: &'static str = "/etc/data-agent.yaml";
...
#[cfg(target_os = "windows")]
mod platform_consts {
    pub const DEFAULT_LOG_FILE: &'static str = "C:\\DeepFlow\\data-agent\\log\\data-agent.log";
    // NOTE yaml must be full path, otherwise service wouldn't start as you wish.
    pub const DEFAULT_CONF_FILE: &'static str = "C:\\DeepFlow\\data-agent\\data-agent-windows.yaml";
    pub const DEFAULT_TRIDENT_CONF_FILE: &'static str =
        "C:\\DeepFlow\\trident\\trident-windows.yaml";
    pub const DEFAULT_COREFILE_PATH: &'static str = "C:\\DeepFlow\\data-agent";

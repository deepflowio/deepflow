...
#[cfg(target_os = "linux")]
use super::ebpf::{MSG_REQUEST, MSG_REQUEST_END, MSG_RESPONSE, MSG_RESPONSE_END};
pub use super::enums::L4Protocol;
pub use super::l7_protocol::L7Protocol;
use super::{
    decapsulate::TunnelType,
    enums::{Direction, EthernetType, IpProtocol, TapSide, TapType, TcpFlags},
    tap_port::TapPort,
};

use crate::flow_generator::FlowState;
use crate::proto::{common::TridentType, flow_log};
use crate::protocol_logs::{duration_to_micros, to_string_format};
use crate::utils::net::MacAddr;

const COUNTER_FLOW_ID_MASK: u64 = 0x00FFFFFF;
const EPC_FROM_INTERNET: i32 = -2;

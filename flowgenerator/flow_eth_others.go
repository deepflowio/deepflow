...
func (m *FlowMap) updateEthOthersFlow(flowExtra *FlowExtra, meta *MetaPacket) {
	...
	if flowExtra.taggedFlow.FlowMetricsPeers[FLOW_METRICS_PEER_SRC].PacketCount > 0 && flowExtra.taggedFlow.FlowMetricsPeers[FLOW_METRICS_PEER_DST].PacketCount > 0 {

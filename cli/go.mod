...
require (
	...
	github.com/deepflowio/deepflow/message v0.0.0-20250708084200-e43fb36910f7
...
require (
	...
	github.com/deepflowio/deepflow/server/controller/db/mysql/migrator/edition v0.0.0-20240913001216-68c04e44504b // indirect

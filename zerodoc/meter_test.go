...
func TestMeterReverse(t *testing.T) {
	meters := []app.Meter{&FlowMeter{}, &FPSMeter{}, &GeoMeter{}, &LogUsageMeter{}, &PerfMeter{}, &TypeMeter{}, &UsageMeter{}, &VTAPUsageMeter{}, &VTAPSimpleMeter{}}
	interestedFieldPairs := [][]string{
		{"SumBitTx", "SumBitRx"},
		{"SumPacketTx", "SumPacketRx"},
		{"SumRetransCntTx", "SumRetransCntRx"},
		{"SumZeroWndCntTx", "SumZeroWndCntRx"},
	}
